...
export default function Carousel() {
  ...
  return (
    ...
    <div className="min-w-[30rem] h-[30rem] w-screen bg-navy ">
        <div className='  my-5 w-11/12 py-10  h-[27rem] grid place-content-center'>
            <Swiper
              spaceBetween={10}
            ...
            >
        {
            ...
            slides.map((slide,index)=> (
                <SwiperSlide key={index} className='justify-center  h-56 sm:h-64 ' >
                    <div className=" object-centeer overflow-hidden  w-11/12 sm:w-full h-full  ">
                        <img  src={slide}  />
                    </div>
                </SwiperSlide> 
            ))
